...
<div class="breadcrumb-area section-ptb">
    <div class="container">
        <div class="row">
            <div class="col">
                <h2 class="breadcrumb-title">Dog Beds</h2>
...
<?php require_once('../products/db/dogs_cat.php'); ?>


<?php
    $products = json_decode(getAllDogbeds(), true);
?>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                            ...
                                            <div class="single-product-wrap">
                                                ...
                                                <div class="product-content">
                                                    <h3>
                                                        <a
                                                            href="/products/single.php?product=<?php echo $product['id'] ?>"><?php echo $product['title'] ?>
                                                        </a>
                                                    </h3>

                                                    <div class="price-box">
                                                        <span class="old-price"><span class="money"
                                                                data-currency-usd="<?php echo $product['price'] ?>"><?php echo $product['price'] ?></span></span>
                                                        <span class="new-price"><span class="money"
                                                                data-currency-usd="<?php echo $product['sale_price'] ?>"><?php echo $product['sale_price'] ?></span></span>
                        ...
                        <div class="shop-sidebar-wrap">
                            <div class="shop-sidebar-inner">
                                <div class="shop-sidebar mb--30">
                                    ...
                                    <ul>
                                        <li class=""><a href="#">Bird Accessories
                                                <span>(47)</span></a></li>

                                        <li class=""><a href="#">Bird Feeding
                                                <span>(226)</span></a></li>

                                        <li class=""><a href="#">Bird Toys <span>(85)</span></a>
                                        </li>

                                        <li class=""><a href="#">Bow Ties <span>(92)</span></a></li>

                                        <li class=""><a href="#">Bowls &amp; Kits
                                                <span>(27)</span></a></li>
                                ...
                                <div class="shop-sidebar mb--30">
                                    ...
                                    <ul>
                                        <li class=""><a href="/collections/bird-cages.php">Bird Cages</a></li>
                                        <li class=""><a href="/collections/bird-toys.php">Bird Toys</a></li>
                                        <li class=""><a href="/collections/dog-beds.php">Dog Cages</a></li>
                                        <li class=""><a href="/collections/fish-bowls.php">Fish Bowls</a></li>
                                    </ul>
                                </div>
                                <div class="shop-sidebar  mb--30">
                                    ...
                                    <div class="sidebar-tag">
                                        ...
                                        <a href="/collections/dog-beds.php">dogbeds</a>
                                    </div>
                                </div>
